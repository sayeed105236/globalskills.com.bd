        ...
        <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
          <div class="course-detail-bx">
            <div class="course-price">
              <del>BDT {{$course->regular_price}}</del>
              <h4 class="price">BDT {{$course->sale_price}}</h4>
            </div>
            <div class="course-buy-now text-center">
              <a href="/admin/home/course_details/view/{{$course->id}}" class="btn radius-xl text-uppercase">Enroll this Course</a>
            </div>
