<div class="modal fade" id="LessonAddModal" tabindex="-1" role="dialog" aria-labelledby="LessonAddModal" aria-hidden="true">
        ...
        <form action="{{route('store-lesson')}}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="vimeo_id" aria-describedby="vimeo_id" placeholder="Vimeo Id">

            </div>
            <div class="form-group">
              <label for="lesson_title">Lesson Title</label>
              <input type="text" class="form-control" name="lesson_title" aria-describedby="lesson_title" placeholder="Enter Lesson name">
            ...
            <div class="form-group">
                <label for="exampleFormControlFile1">Lesson Files</label>
                  <input type="file" name="file" class="form-control-file" id="files" onchange="previewImage(this)">
            </div>
