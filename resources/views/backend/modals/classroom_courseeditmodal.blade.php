  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ClassroomCourseEditModal{{$row->id}}">Edit Course</h5>
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
          ...
          <input type="hidden" name="id" value="{{$classroom_courses->id}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{$classroom_courses->course_title}}" name="classroom_course_title" aria-describedby="classroom_course_title" placeholder="Enter title">
